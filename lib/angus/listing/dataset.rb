...
module Angus
  module Listing
    ...
    class DataSet
      ...
      #
      # @param [#to_sym] name Column's name
      # @param [Symbol] raw_sql
      def self.column(name, raw_sql = nil)
        @columns ||= {}
        @columns[name.to_sym] = raw_sql
      end

      # param [Hash] q Q options, see Angus::Listing::Q.new
